...
const getDietaryChoiceSummary = function () {
    const selectedDiet = document.querySelector('input[name="answerdiet"]:checked');
    let scoreDiet = 0;
  ...
  const energyConsumptionValue = document.getElementById("energyConsumptionValue");
  ...
  const buttonMinimalistScore = document.getElementById("button_minimalist_score");
